...
// Expanded mock discovery data - events, places, experiences, communities
const allDiscoveries = [
  {
    ...
    price: 45,
    image:
      "https://images.unsplash.com/photo-1489599063910-2d1c49be6aa0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80",
    attendees: 150,
    rating: 4.9,
    category: "Experience",
    featured: true,
  ...
  },
  {
    ...
    price: 89,
    image:
      "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80",
    attendees: 1200,
    rating: 4.6,
    category: "Business",
    featured: true,
  ...
  },
  {
    ...
    price: 50,
    image:
      "https://images.unsplash.com/photo-1577303935007-0d306ee638cf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80",
    attendees: 100,
    rating: 4.8,
    category: "Technology",
    featured: false,
  ...
  },
  {
    ...
    price: 129,
    image:
      "https://images.unsplash.com/photo-1542038784456-1ea8e732c8e6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80",
    attendees: 15,
    rating: 4.9,
    category: "Art",
    featured: false,
...
const types = ["All", "event", "place", "experience", "community"];
                  ...
                  <div className="space-y-3">
                    {types.slice(1).map((type) => (
                      ...
                      >
                        ...
                        <label
                          htmlFor={type}
                          className="text-sm text-gray-700 dark:text-gray-200 cursor-pointer font-medium capitalize"
                        >
                          {type}
                        </label>
                      </motion.div>
...
const DiscoveryCard = ({
  ...
  discovery: (typeof allDiscoveries)[0];
  index: number;
  viewMode: "grid" | "list";
}) => {
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <Badge
                          variant={getCategoryBadgeVariant(discovery.category) as any}
                          size="lg"
                          glow="medium"
                        >
                          {discovery.category}
                        ...
                        <Badge variant="outline" className="text-xs">
                          {getTypeIcon(discovery.type)} {discovery.type}
                        </Badge>
                      </div>
      ...
      >
        <Card className="genz-event-card overflow-hidden">
          <div className="relative overflow-hidden">
            ...
            {/* Engagement overlay */}
            <div className="absolute bottom-4 right-4 flex items-center gap-2 text-white/90 text-sm">
...
export default function Discover() {
  ...
  const filteredDiscoveries = allDiscoveries.filter((discovery) => {
    const matchesSearch =
      ...
      discovery.location.toLowerCase().includes(searchQuery.toLowerCase());

    const matchesCategory =
      selectedCategory === "All" || discovery.category === selectedCategory;

    const matchesType =
      selectedType === "All" || discovery.type === selectedType;

    // Advanced filter logic
    const matchesPrice =
      !filtersApplied ||
      (discovery.price >= priceRange[0] && discovery.price <= priceRange[1]);

    const matchesAdvancedCategories =
      !filtersApplied ||
      selectedCategories.length === 0 ||
      selectedCategories.includes(discovery.category);

    const matchesAdvancedTypes =
      !filtersApplied ||
      selectedTypes.length === 0 ||
      selectedTypes.includes(discovery.type);

    const matchesRating =
      !filtersApplied || selectedRating === 0 || discovery.rating >= selectedRating;
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="body-text text-base lg:text-lg leading-relaxed">
                Uncover hidden gems, unique experiences, and vibrant communities!
              </p>
            </div>
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="text-center md:text-left">
              <h2 className="neon-heading text-3xl mb-2">
                ⚡ Ready to Share Your Own Discovery? ⚡
              </h2>
              <p className="body-text text-lg text-white/90">
                Join creators sharing unique experiences, hidden spots, and amazing communities worldwide!
              </p>
              <div className="flex items-center gap-6 mt-4 text-sm">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center">
                    <Zap className="text-black w-4 h-4 font-bold" />
                  </div>
                  <span>Get featured globally</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="flex-1">
            ...
            >
              <div className="flex flex-col md:flex-row gap-4 mb-6">
                <div className="relative flex-1">
                  ...
                  <Input
                    placeholder="Search experiences, places, communities..."
                    value={searchQuery}
            ...
            >
              <p className="body-text">
                Found {sortedDiscoveries.length} discoveries
